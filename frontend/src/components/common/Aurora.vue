<template>
  <div ref="ctnDom" class="aurora-container" aria-hidden="true" />
</template>
...
const toColorArray = (stops: readonly string[]) => stops.map((hex) => {
...
onUnmounted(() => {
  ...
  if (canvas.parentNode === ctnDom.value) ctnDom.value?.removeChild(canvas)
